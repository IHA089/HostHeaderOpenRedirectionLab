...
HostHeaderOpenRedirection = Flask(__name__)
HostHeaderOpenRedirection.secret_key = "vulnerable_lab_by_IHA089"
...
@HostHeaderOpenRedirection.route('/')
def home():
    if not check_cookies():
        session.clear()
    return render_template('index.html', user=session.get('user'))

@HostHeaderOpenRedirection.route('/index.html')
def index_html():
    if not check_cookies():
        session.clear()
    return render_template('index.html', user=session.get('user'))

@HostHeaderOpenRedirection.route('/login.html')
def login_html():
    if not check_cookies():
        session.clear()
    return render_template('login.html')

@HostHeaderOpenRedirection.route('/join.html')
def join_html():
    if not check_cookies():
        session.clear()
    return render_template('join.html')

@HostHeaderOpenRedirection.route('/forgot-password.html')
...
@HostHeaderOpenRedirection.route('/acceptable.html')
def acceptable_html():
    if not check_cookies():
        session.clear()
    return render_template('acceptable.html', user=session.get('user'))

@HostHeaderOpenRedirection.route('/term.html')
def term_html():
    if not check_cookies():
        session.clear()
    return render_template('term.html', user=session.get('user'))

@HostHeaderOpenRedirection.route('/privacy.html')
def privacy_html():
    if not check_cookies():
        session.clear()
...
@HostHeaderOpenRedirection.route('/confirm', methods=['POST'])
def confirm():
...
@HostHeaderOpenRedirection.route('/resend', methods=['POST'])
def resend():
    username = request.form.get('username')
    password = request.form.get('password')
    hash_password=hashlib.md5(password.encode()).hexdigest()
...
@HostHeaderOpenRedirection.route('/login', methods=['GET', 'POST'])
def login():
...
@HostHeaderOpenRedirection.route('/resetpassword', methods=['POST'])
def resetpassword():
    password=request.form.get('password')
...
@HostHeaderOpenRedirection.route('/join', methods=['GET', 'POST'])
def join():
    if not check_cookies():
        session.clear()
    if 'user' in session:
...
@HostHeaderOpenRedirection.route('/reset', methods=['GET'])
def reset():
...
@HostHeaderOpenRedirection.route('/forgot', methods=['POST'])
def forgot():
    try:
...
@HostHeaderOpenRedirection.route('/dashboard')
...
@HostHeaderOpenRedirection.route('/logout.html')
def logout():
    session.clear() 
...
@HostHeaderOpenRedirection.route('/profile')
...
@HostHeaderOpenRedirection.route('/reset_password', methods=['POST'])
def reset_password():
    username = request.form.get('username')
...
@HostHeaderOpenRedirection.after_request
